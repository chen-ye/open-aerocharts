...
def merge_runways(
    cifp_path="data/cifp_runways.fgb",
    cifp_labels_path="data/cifp_runway_labels.fgb",
    am_path="data/am_runways.fgb",
    output_path="data/runways.fgb",
    output_labels_path="data/runway_labels.fgb",
):
    ...
    if am_exists:
        try:
            ...
            if not am_gdf.empty:
                ...
                am_gdf.drop(
                    columns=[c for c in cols_to_drop if c in am_gdf.columns],
                    inplace=True,
                )
    ...
    if cifp_exists:
        try:
            ...
            if not cifp_gdf.empty:
                ...
                # Normalize Identifier
                cifp_gdf.rename(
                    columns={"airport": "airport_id", "runway": "runway_id"},
                    inplace=True,
                )
