...
export const MobileBottomSheet: React.FC<MobileBottomSheetProps> = ({
	...
	return (
		<Box
			className={`map-feature-panel mobile-only ${isCollapsed ? "is-collapsed" : ""}`}
		>
			<Card
				size="2"
				style={{
			...
			>
				<Tabs.Root
					...
					onValueChange={() => setIsCollapsed(false)}
				>
					<Box pt="1">
					...
					<Box
						px="4"
						py="4"
						style={{ height: "calc(50vh - 50px)", overflowY: "auto" }}
					>
							...
							{selectedFeatures ? (
								...
								>
									<Text color="gray" align="center">
										Tap on the map to inspect features.
									</Text>
								</Flex>
							)}
						</Tabs.Content>
